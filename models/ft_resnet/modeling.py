...
def train_model(model, dataloaders, criterion, optimizer, num_epochs, device, save_dir):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        # save losses
        if epoch % 20 == 0:
            pickle.dump(train_loss_history, open(os.path.join(models_dir, train_loss_pkl), 'wb'))
            pickle.dump(val_loss_history, open(os.path.join(models_dir, val_loss_pkl), 'wb'))
